...
function ServerHopFactory.new(layoutOrder: number?): ServerHopUI
    local maid = Maid.new()

    local row = Instance.new("Frame")
    row.Name = "ServerHopRow"
    ...
    subtitle.Text = "Joins a random low-latency server"

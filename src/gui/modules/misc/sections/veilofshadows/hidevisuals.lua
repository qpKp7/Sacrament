...
export type HideVisualsUI = {
    Instance: Frame,
    Toggled: RBXScriptSignal,
    GetState: (self: HideVisualsUI) -> boolean,
    Destroy: (self: HideVisualsUI) -> ()
}

local HideVisualsFactory = {}
...
function HideVisualsFactory.new(layoutOrder: number?): HideVisualsUI
    ...
    return self :: HideVisualsUI
end

return HideVisualsFactory

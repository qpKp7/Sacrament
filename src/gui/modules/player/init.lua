--!strict
--[[
    SACRAMENT | Player Orchestrator (init)
    Responsável pela composição e gerenciamento de estado da aba Player.
--]]
...
function PlayerModuleFactory.new(): PlayerModule
    ...
    local function applyState(item: AccordionItem, open: boolean, animate: boolean)
        ...
        if open then
            ...
            -- RECALCULA LAYOUT (Vital para sub-frames com scrolling)
            task.defer(function()
...
-- Factory Method para compatibilidade com o UI Manager
